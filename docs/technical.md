...
'''
 ...
 - Pydantic Models – validate and normalize data.
 - SQLite – stores offers and processed data.
 - JobClassificationService – classifies job category and seniority.
 - SalaryHistory – provides historical salary statistics.
