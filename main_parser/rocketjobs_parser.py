...
skip = skip = [
    ...
    "sprawdź podobne",
    "mamy dla ciebie nowe oferty pracy", "mamy dla ciebie nowe oferty",
    "twoje preferencje", 
    "mamy dla Ciebie nowe oferty twoje preferencje: Logistyka, Wrocław, 30 km, Specjalista / Mid, Młodszy specjalista / Junior"
]
